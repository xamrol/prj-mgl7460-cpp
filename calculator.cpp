...
string TimeConversion::getLocalTime()
{
   ...
   // int secondes, minutes, heures;
    ...
    actualLocalTime = ((nbHeures>9)? to_string(nbHeures):'0'+to_string(nbHeures)) + ':' + 
		((nbMinutes>9)? to_string(nbMinutes):'0'+to_string(nbMinutes)) + ':' + 
		((nbSecondes>9)? to_string(nbSecondes):'0'+to_string(nbSecondes));
